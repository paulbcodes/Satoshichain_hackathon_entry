...
const CONTRACT_ADDRESS = "0x852830976062f68E6Ab350B072Dc150955ea0D00";
...
export function App(props) {
  ...
  const chats = friends
    ? friends.map((friend) => {
        return (
          <ChatCard style={{borderRadius: "3px", borderColor: "#d19406" }}
  ...
  return (
    <Container style={{ padding: "0px", border: "9px solid #d19406" }}>
      ...
      <Row>
        ...
        <Col style={{ paddingRight: "0px", borderRight: "3px solid #d19406",  color: "#d19406" }}>
          <div
            style={{
          ...
          >
            <Row style={{ marginRight: "0px" }}>
              ...
              >
                <Card.Header><b>Friends List</b></Card.Header>
              </Card>
            </Row>
            {chats}
            <AddNewChat
        ...
        <Col xs={8} style={{ paddingLeft: "0px" }}>
          <div style={{ backgroundColor: "#000000", height: "100%" }}>
            ...
            <Row style={{ marginRight: "0px" }}>
              ...
              >
                <Card.Header>
                  Chatting with {activeChat.friendname} 
                  <Button
                    style={{ float: "right" }}
                    variant="warning"
                    onClick={() => {
